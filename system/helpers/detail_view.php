...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <?php $detail_link = site_url('show/detail/'.$row->unique_id.'/'.url_title($estate_title));; ?>
...
<!--                </li>-->
            ...
            <div class="title"><i class="fa fa-home fa-4"></i>&nbsp;<?php echo lang_key('DBC_DESCRIPTION'); ?></div>
            ...
            <div class="panel-body">
				...
				<div class="title"><i class="fa fa-rocket fa-4"></i>&nbsp;<?php echo lang_key('Information'); ?></div>
                ...
                <li class="list-group-item">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Property Address'); ?>: <?php echo lang_key($row->address);?></span></div>
                    </div>
                </li>	
				...
				<li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Type'); ?>: <?php echo lang_key($row->type);?></span></div>
                    </div>
				 ...
				 <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Construction Type'); ?>: <?php echo lang_key($row->construction_type);?></span></div>
                    </div>
				 ...
				 <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('No of Bedrooms'); ?>: <?php echo lang_key($row->bedroom);?></span></div>
                    </div>
                </li>	<!-- list-group-item -->
				<li class="list-group-item">
                    <div class="row">

                       <div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('No of Bathrooms'); ?>: <?php echo lang_key($row->bath);?></span></div>
                    </div>
                </li>	<!-- list-group-item -->
				 ...
				 <li class="list-group-item">
                    <div class="row">
						...
						<div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Sq Ft'); ?>: <?php echo lang_key($row->price_unit);?></span></div>
                    </div>
				 ...
				 <li class="list-group-item">
                    <div class="row">
						 ...
						 <div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Paying Tenants'); ?>: <?php echo lang_key($row->estate_condition);?></span></div>
                    </div>
				 ...
				 <li class="list-group-item">
                    <div class="row">
						...
						<div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Basement'); ?>: <?php echo lang_key($row->estate_condition);?></span></div>
                    </div>
				...
				<li class="list-group-item">
                    <div class="row">
						...
						<div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Garage'); ?>: <?php echo lang_key($row->estate_condition);?></span></div>
                    </div>
            ...
            <div class="title"><i class="fa fa-rocket fa-4"></i>&nbsp;<?php echo lang_key('Financials'); ?></div>
            ...
            <div class="panel-body">
                ...
                <div class="row property-amenities">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Sales Price'); ?>: <?php echo lang_key($row->estate_condition);?></span></div>
					<br>
<div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Monthly Rent'); ?>: <?php echo lang_key($row->estate_condition);?></span></div>
<br>
<div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Yearly Rent'); ?>: <?php echo lang_key($row->year_rent);?></span></div>
<br>
<div class="col-md-4 col-sm-4 col-xs-6 titles"><span><i class="fa fa-ticket"></i> <?php echo lang_key('Property Taxes'); ?>: <?php echo lang_key($row->estate_condition);?></span></div>
                    </ul><!-- /.span2 -->                   
        ...
        <div class="orange-border panel panel-primary">
            ...
            <div class="panel-heading orange"><i class="fa fa-map-marker"></i> <?php echo lang_key('DBC_LOCATION_MAP'); ?></div>
...
<!--                </div>-->
        ...
        <div class="orange-border panel panel-primary">
            ...
            <div class="panel-heading orange"><i class="fa fa-image"></i> <?php echo lang_key('DBC_IMAGE_GALLERY'); ?></div>
        ...
        <div class="orange-border panel panel-primary">
            ...
            <div class="panel-heading orange"><i class="fa fa-image"></i> <?php echo lang_key('DBC_VIDEO_EMBED'); ?></div>
    ...
    <div class="col-md-3 ">
        ...
        <div class="detail-title"><i class="fa fa-star-o"></i>&nbsp;<?php echo lang_key('DBC_SUMMARY'); ?></div>

        <div class="orange-border panel panel-primary effect-helix in">

            <div class="panel-heading orange"><?php echo lang_key('DBC_OVERVIEW'); ?></div>
            ...
            <div class="panel-body">
                ...
                <div class="info_list">
                    ...
                    <span class="info-title" style=""><?php echo lang_key('DBC_ADDRESS'); ?>:</span>
                ...
                <div class="info_list">
                    ...
                    <span class="info-title" style=""><?php echo lang_key('DBC_CITY'); ?>:</span>
                ...
                <div class="info_list">
                    ...
                    <span class="info-title" style=""><?php echo lang_key('DBC_STATE_PROVINCE'); ?>:</span>
                ...
                <div class="info_list">
                    ...
                    <span class="info-title" style=""><?php echo lang_key('DBC_COUNTRY'); ?>:</span>
        ...
        <div class="widget our-agents" id="agents_widget-2">
            ...
            <div class="detail-title"><i class="fa fa-user"></i>&nbsp;<?php echo lang_key('DBC_AGENT'); ?></div>
        ...
        <div class="detail-title"><i class="fa fa-envelope-o"></i>&nbsp;<?php echo lang_key('DBC_MESSAGE'); ?></div>
        ...
        <form action="<?php echo site_url('show/sendemailtoagent/'.$row->created_by);?>" method="post" id="message-form">
            ...
            <label><?php echo lang_key('DBC_EMAIL_SUBJECT');?>:</label>

            <input type="text" name="subject" value="<?php echo set_value('subject');?>" class="form-control">

            <?php echo form_error('subject');?>

            <label><?php echo lang_key('DBC_MESSAGE'); ?>:</label>
