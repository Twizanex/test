...
<link rel="stylesheet" type="text/css" href="http://127.0.0.1/condivisi/test/assets/admin/assets/bootstrap-wysihtml5/bootstrap-wysihtml5.css">
<style type="text/css">
.file-upload{
  margin:0 !important;
  padding:0 !important;
    ...
    <div class="agent-container" id="panel">
      ...
      <form class="form-horizontal" id="addpackage" action="<?php echo site_url('admin/realestate/updateestate');?>" method="post">
        ...
        <div class="box">
              ...
              <div class="tab-content" id="myTabContent1">
               ...
               <div id="<?php echo $lang->short_name;?>" class="tab-pane fade in <?php echo ($flag==1)?'active':'';?>">
                ...
                <div class="form-group">
                  <label class="col-sm-3"><?php echo lang_key('title');?>:</label>
                  <div class="col-sm-4">
                    <?php 
                ...
                <div class="form-group">
                  <label class="col-sm-3"><?php echo lang_key('description');?>:</label>
                  <div class="col-sm-7">
                    <?php 
          ...
          <div class="form-group">
            <label class="col-sm-3"><?php echo lang_key('purpose');?> :</label>
            <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="col-sm-3 "><?php echo lang_key('type');?>:</label>
              <div class="col-sm-4 ">
                <?php $types = array();
              ...
              <div id="sales-price-holder">
                <div class="form-group">
                  <label id="sales-label" class="col-sm-3"><?php echo lang_key('sales_price');?>:</label>
                  <div class="col-sm-4 ">
                    <div class="input-group">
                      <span class="input-group-addon"><?php echo get_settings('site_settings','default_currency','$');?></span>
                ...
                <div class="form-group">
                  <label class="col-sm-3"><?php echo lang_key('price_per_unit');?>:</label>
                  <div class="col-sm-4">
                    <div class="input-group">
                      <span class="input-group-addon"><?php echo get_settings('site_settings','default_currency','$');?></span>
              ...
              <div id="rent-price-holder" class="form-group">
                <label class="col-sm-3"><?php echo lang_key('rent_price');?>:</label>
                <div class="col-sm-4 ">
                  <div class="input-group">
                ...
                <label class="col-sm-3 ">Date format:</label>
                <div class="col-sm-4">
              ...
              <div id="home-size-holder" class="form-group">
                <label class="col-sm-3"><?php echo lang_key('home_size');?>:</label>
                <div class="col-sm-4 ">
              ...
              <div id="lot-size-holder" class="form-group">
                <label class="col-sm-3 "><?php echo lang_key('lot_size');?>:</label>
                <div class="col-sm-4 ">
              ...
              <div id="bedroom-holder" class="form-group">
                <label class="col-sm-3 "><?php echo lang_key('bedrooms');?>:</label>
                <div class="col-sm-4 ">
              ...
              <div id="bath-holder" class="form-group">
                <label class="col-sm-3 "><?php echo lang_key('baths');?>:</label>
                <div class="col-sm-4 ">
              ...
              <div id="year-built-holder" class="form-group">
                <label class="col-sm-3 "><?php echo lang_key('year_built');?>:</label>
                <div class="col-sm-4 ">
              ...
              <div class="form-group">
                <label class="col-sm-3 "><?php echo lang_key('energy_efficiency');?> :</label>
                <div class="col-sm-4 ">
                ...
                <div class="form-group">
                  <label class="col-sm-3 "><?php echo lang_key('status');?> :</label>
                  <div class="col-sm-4 ">
                  ...
                  <?php if(is_admin()){ ?>
                  <div class="form-group">
                    <label class="col-sm-3 "><?php echo lang_key('agent');?> :</label>
                    <div class="col-sm-4">
                      <?php $CI = get_instance();
                  ...
                  <div id="year-built-holder" class="form-group">
                    <label class="col-sm-3 "><?php echo lang_key('tags');?>:</label>
                    <div class="col-sm-4 ">
                  ...
                  <div class="box-content">
                    ...
                    foreach ($fields as $field) {
                      ...
                      if($field['type']=='text')
                      {
                        ?>
                        <div class="form-group">
                          <label class="col-sm-3 "><?php echo lang_key($field['title']); ?>:</label>
                          <div class="col-sm-6">
                  ...
                  if(count($distance_info)>0)
                  {
                    foreach ($distance_info as $key => $distance) {
                      ...
                      <div class="form-group">
                        ...
                        <label class="col-sm-3 "><?php echo $val->{'title'}; ?>:</label>
                        <div class="col-sm-4 ">
                          <div class="input-group">
                        ...
                        <div class="col-sm-4">
                          ...
                          <select class="form-control input-sm" name="distance_unit[]">
                            <?php
                            $units = array('Meter(s)'=>'Meter(s)','Feet(s)'=>'Feet(s)', 'Kilometer(s)' => 'Kilometer(s)', 'Mile(s)' => 'Mile(s)');
                ...
                <div class="col-md-7">
                  ...
                  <div class="box">
                    ...
                    <div class="box-content">
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 "><?php echo lang_key('address');?>:</label>
                        <div class="col-sm-7">
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 "><?php echo lang_key('country');?>:</label>
                        <div class="col-sm-7 ">
                        ...
                        <div class="form-group">
                          <label class="col-sm-4 "><?php echo lang_key('state_province');?>:</label>
                          <div class="col-sm-7">
                        ...
                        <div class="form-group">
                          <label class="col-sm-4"><?php echo lang_key('city');?>:</label>
                        ...
                        <div class="form-group">
                          <label class="col-sm-4 "><?php echo lang_key('zip_code');?>:</label>
                          <div class="col-sm-7 ">
                  ...
                  <div class="box">
                    ...
                    <div class="box-content">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 "><?php echo lang_key('featured_image');?>:</label>
                        <div class="col-sm-4 ">                    
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 "><?php echo lang_key('embed_video_url');?>:</label>
                        <div class="col-sm-4 ">
                      ...
                      <div class="form-group">
                       ...
                       <label class="col-sm-3 "><?php echo lang_key('estate_brochure');?>:</label>
                       <div class="col-sm-4 ">
                     ...
                     <?php if($v != ''){
                       ?>
                       <span id="brochure-error"><label class="col-sm-3 ">&nbsp;</label><div class="col-sm-4 col-lg-5"><div class="alert alert-success" style="margin-bottom:0;"><?php echo $v;?></div></div></span>
                       <?php
                     } else {
                       ?>
...
<script src="http://127.0.0.1/condivisi/test/assets/admin/assets/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<script src="http://127.0.0.1/condivisi/test/assets/admin/assets/jquery-cookie/jquery.cookie.js"></script>

<!--Calendar-->
<script src="http://127.0.0.1/condivisi/test/assets/admin/assets/jquery-ui/jquery-ui.min.js"></script>
<script src="http://127.0.0.1/condivisi/test/assets/admin/assets/ckeditor/ckeditor.js"></script> 


<!--Template Scripting-->
<script src="http://127.0.0.1/condivisi/test/assets/admin/js/memento.js"></script>
<script src="http://127.0.0.1/condivisi/test/assets/admin/js/memento-demo-codes.js"></script>
