                  ...
                  <div id="no-more-tables">
                    ...
                    <table class="table table-hover">
                     ...
                     <thead>
                       ...
                       <tr>
                        ...
                        <th class="numeric">Visit</th><th class="numeric">Featured</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td data-title="Type" class="numeric"><?php echo lang_key($row->total_view);?></td>
                        ...
                        <td data-title="Action" class="numeric">
                          ...
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-info">
                              ...
                              <li><a href="<?php echo site_url('profile/editestate/'.$curr_page.'/'.$row->id);?>">Edit</a></li>
                              <li><a href="<?php echo site_url('admin/realestate/deleteestate/'.$curr_page.'/'.$row->id);?>">Delete</a></li>
                              <?php if(is_admin()){?>
                              <?php if($row->status==2){?>
