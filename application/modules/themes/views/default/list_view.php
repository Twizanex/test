                ...
                <div style="margin-top:10px"></div>
                    <div class="col-md-3 col-sm-3">
                        <div class="property-header">
                            ...
                            <img class="property-header-image" src="<?php echo get_featured_photo_by_id($row->featured_img);?>" alt="" style="width:100%">
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="caption" style="padding: 2px;">                            
                            ...
                            <div style="clear:both;">
                                ...
                                <?php }else{?>
                                <span style="float:right; "><?php echo $row->home_size;?> <?php echo $row->home_size_unit;?></sup></span>
                                <?php }?>
                            </div>
