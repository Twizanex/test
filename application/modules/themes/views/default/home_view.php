...
?>
        <div class="row">
          ...
          <div id="data-content" class="col-md-9"  style="-webkit-transition: all 0.7s ease-in-out; transition: all 0.7s ease-in-out;">
                <div class="recent-grid"><i class="fa fa-home fa-4"></i>&nbsp;<?php echo lang_key('recent_estates'); ?>
              ...
              <div class="recent-grid"><i class="fa fa-home fa-4"></i>&nbsp;<?php echo lang_key('featured_estates'); ?>
                  <?php require'switcher_view.php';?>
              </div>
              <?php
