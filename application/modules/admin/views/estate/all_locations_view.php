                  ...
                  <td data-title="Action" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/realestate/editlocation/'.$row->type.'/'.$row->id);?>" class="edit-location">Edit</a></li>
                          <li><a href="<?php echo site_url('admin/realestate/deletelocation/'.$curr_page.'/'.$row->id);?>">Delete</a></li>
