                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/system/savesmtpemailsettings');?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="smtp_host" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="smtp_port" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="smtp_timeout" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="smtp_user" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="smtp_pass" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="char_set" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="new_line" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            ...
                            <input type="text" name="mail_type" value="<?php echo $v;?>" placeholder="Type something" class="form-control" >
