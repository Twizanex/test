    ...
    public function getViewerUpdates($viewing_user, $page, $last_id = false)
    {
        $this->db->select(
                   'u.id as update_id,
                    ...
                    ure.user_name as reshare_username,
                    s.domain,
                    s.name,
                    s.icon,
                    url.link,
                ...
                join('view', 'u.user = view.user_show AND dbc_view.user_view = ' . $viewing_user)->
                join('users', 'u.user = users.id')->
                ...
                join('users ure', 'ure.id = u.update_reshare_user_id', 'left')->
                where('u.update_delete', 0)->
                order_by('u.id', 'desc')->limit($this->PER_PAGE, ($page-1) * $this->PER_PAGE);
